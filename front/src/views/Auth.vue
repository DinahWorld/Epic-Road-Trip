      ...
      <div style="filter: blur(4px); background-color: rgba(0, 0, 0, 0.316);">
        ...
        <div class="glass-container">
          ...
          <p class="error">{{error}}</p>
            <input type="text" v-model="email" class="input" style="margin-top: 3%" id="lname" name="lastname" placeholder="E-mail">
            <input type="password" class="input" v-model="password" style="margin-top: 5%" id="lname" name="lastname" placeholder="Mot de passe">
        ...
        <div v-if="signup && !signin" id="centered-text" style="top: 7vh;">
            <div class="glass-container" style="height: 90vh">
                ...
                <p class="error">{{error}}</p>
                  <input v-model="name" type="text" class="input" style="margin-top: 3%" id="lname" name="lastname" placeholder="Prénom">
                  <input v-model="email" type="text" class="input" style="margin-top: 5%" id="lname" name="lastname" placeholder="E-mail">
                  <input v-model="password" type="password" class="input" style="margin-top: 5%" id="lname" name="lastname" placeholder="Mot de passe">
                  <div class="button-row">
                      <v-btn class="button-signin no-shadow" color="#164465" height="7vh" width="25vh"  v-on:click="createAccount">
                        Inscription
                      </v-btn>
